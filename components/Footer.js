  ...
  return (
    <div className="flex justify-center mt-6">
        <div className="footer-container max-w-screen-lg w-full leading-relaxed">
            <p>This is the story of the Urban Uprise Crew, an army of 10,000 musicians, artists, and their fans who had their creative souls stolen by the tricky money-hungry Shadow Dwellers.</p><br /><p>We call on you to mint a Crew Member which will free a soul from captivity. The more we free, the bigger our creative power becomes, revealing a fury of talent that will destroy the Shadow Dwellers' rule, forever. </p>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://urbanuprisecrew.com/" className="hover:underline">URBAN UPRISE CREW™</a>. All Rights Reserved. Built by <a href="https://creativeplatform.xyz">CREATIVE platform.</a>
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/creativecrtv" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path></svg>
                <span className="sr-only">Facebook page</span>
            </a>
            <a href="https://www.instagram.com/urban_uprise_crew" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://twitter.com/UrbanUpriseCrew" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
